...
export function FeatureSection() {
  ...
  return (
    <div ref={containerRef} className="mx-auto w-full max-w-7xl space-y-12 py-16 px-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-border/10 bg-muted/5 backdrop-blur-sm">
        <div className="grid grid-cols-1 gap-px bg-border/10 sm:grid-cols-2 lg:grid-cols-4">
...
const features: FeatureType[] = [
  {
    title: "Next.js 15",
    icon: (
      <svg viewBox="0 0 180 180" className="w-10 h-10 fill-foreground">
