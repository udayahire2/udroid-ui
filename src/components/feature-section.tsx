...
import { File, Moon, PenTool } from "lucide-react";
...
const features: FeatureType[] = [
  {
    ...
    icon: <File className="size-6" strokeWidth={1} />,
    description: "No clutter, just solid structure.",
  },
  {
    title: "Dark Mode Ready",
    icon: <Moon className="size-6" strokeWidth={1} />,
    description: "Beautiful in every color scheme.",
  },
  {
    title: "Fully Customizable",
    icon: <PenTool className="size-6" strokeWidth={1} />,
    description: "Edit, remix, and ship your way.",
  },
  {
    ...
    description: "Straight into your setup.",
  },
  {
    title: "Acenternity UI",
    icon: (
      <img
        src={acenternity}
        alt="Acenternity"
    ...
    description: "Availble Modifiend Acenternity UI.",
  },
  {
    title: "Radix UI",
    icon: (
    ...
    description: "Availble Modified Acenternity UI.",
  },
];
