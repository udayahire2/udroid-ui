    ...
    <div ref={containerRef} className="mx-auto w-full max-w-7xl space-y-12 py-16 px-4">
      <div ref={headerRef} className="mx-auto max-w-3xl text-center space-y-4">
        ...
        <p className="mt-4 text-balance text-muted-foreground text-lg md:text-xl">
          Built with the best technologies for speed, animation, and developer experience.
        </p>
      </div>
...
const features: FeatureType[] = [
  ...
  },
  {
    ...
    description: "Professional-grade animation reliability for complex sequences and scroll effects.",
  },
  {
    title: "Framer Motion",
    icon: (<svg viewBox="0 0 24 24" className="w-10 h-10"><path fill="currentColor" d="M4 0h16v8h-8zm0 8h8l8 8H4zm0 8h8v8z" /></svg>),
    description: "Production-ready declarative animations for fluid layout transitions.",
  },
  {
    title: "Tailwind CSS",
    ...
    description: "Rapid UI development with utility-first classes and a powerful design system.",
  },
];
